...
const ProjectList: Project[] = [
  {
    ...
    latitude: 38.996911967539226,
    longitude: -3.9186039720754353,
    cost: "219.583,72 €",
    state: "Finalizado",
    year_ejecucion: "-",
  ...
  },
  {
    ...
    latitude: 38.975969387002365,
    longitude: -3.9240210689926074,
    cost: "270.569,40 €",
    state: "Por ejecutar",
  ...
  },
  {
    ...
    latitude: 38.974203362208456,
    longitude: -3.9190342049957994,
    cost: "439.254,24 €",
    state: "En ejecución",
  ...
  },
  {
    ...
    budget:
      "Convocatoria de subvenciones para la renaturalización y resiliencia de ciudades 2022",
    description:
      "Los silos de Ciudad Real forman parte de la Red Nacional de Silos, patrimonio arquitectónico y cultural de la historia reciente de España. Desde hace más de tres décadas estas construcciones se encuentran en estado de abandono y solo parte de una de las naves se utiliza actualmente como almacén para algunos servicios municipales. <br> Es una queja vecinal recurrente el estado de abandono de esa parcela, y por ello, en la Agenda Urbana de Ciudad Real la recuperación de este espacio se ha diagnosticado como reto, y las propuestas para dar vida a los Silos se están trabajando dentro del plan de acción de la Agenda Urbana. La parcela donde están construidos los silos, de 7.800 m2, actualmente en estado de degradación, donde se acopian materiales y mobiliario urbano en desuso, está calificada en el PGOU de Ciudad Real como zona verde. La acción contempla la restauración de la parcela de los silos convirtiéndola en una zona verde, donde se revalorice un patrimonio industrial de la ciudad y que a su vez aporte servicios ecosistémicos como nodo de conexión entre corredores verdes de la ciudad. Por sus características de ausencia de actividad, distancia a edificaciones y altura, el edificio tiene un elevado potencial de uso como espacio de nidificación de especies diversas como murciélagos, golondrinas o vencejos. <br> Asimismo, podría constituir un emplazamiento idóneo para el desarrollo de un proyecto a largo plazo de consolidación de un primillar que permitiera incrementar la población de cernícalo primilla (Falco naumanni) en nuestra ciudad. Otra acción complementaria es la obtención de la parcela colindante de 2.290 m2 para poder ampliar el espacio creado en el marco de este proyecto. Con ello, se crearía una zona verde de 16.266 m2 que integraría el actual parque de San Vicente de Paul con las dos zonas creadas.",
    properties1: [
  ...
  },
  {
    ...
    latitude: 38.9682324853356,
    longitude: -3.932960213856049,
    cost: "125.303,8 €",
    state: "Por ejecutar",
  ...
  },
  {
    ...
    latitude: 38.99396880781116,
    longitude: -3.92090052898938,
    cost: "84.656,00 €",
    state: "Finalizado",
    year_ejecucion: "-",
  ...
  },
  {
    ...
    latitude: 38.993974627713285,
    longitude: -3.9203913152260728,
    cost: "84.656,00 €",
    state: "Finalizado",
    year_ejecucion: "-",
  ...
  },
  {
    ...
    location: "Campus Universitario UCLM, 13004 - Ciudad Real",
    latitude: 38.99598660371533,
    longitude: -3.919111388801389,
    cost: "511.960,80 €",
    state: "En ejecución",
    year_ejecucion: "-",
    year_finalizacion: "-",
    ...
    budget:
      "Convocatoria de subvenciones para la renaturalización y resiliencia de ciudades 2022",
    description:
      "La UCLM no solo es un sistema de generación de conocimiento, sino que actúa como potenciadora del emprendimiento y desarrollo de nuestra Comunidad Autónoma. Actualmente, el sector A-UNI que, en la primera década del siglo XXI vio frustrado su desarrollo urbanístico, resulta una ubicación conveniente para alojar todas aquellas actividades de investigación que requieren de infraestructuras específicas por sus singulares características. Es también donde se instala el vivero de empresas nacidas alamparo de la investigación (“Spin Off”). <br> El fracaso del Programa de Actuación Urbanizadora del sector A-Uni en los años 2000 abre la oportunidad de renunciar a esa urbanización “dura” y actuar hacia la consolidación del parque dotacional parque I+D+i UCLM como Campus verde de urbanización blanda que minimice su afección al medio y pueda servir de prototipo de otros espacios similares a desarrollar en otros campus de la UCLM o en la región.<br> El suelo está en la actualidad muy degradado, al ser el resultado de un suelo agrícola de secano sin labrar y con áreas compactadas por el paso de vehículos, por lo que apenas está vegetado, cuando no es utilizado como vertedero ilegal. La acción pretende completar la urbanización “blanda” preexistente sobre la que se ubican las instalaciones universitarias, generando un nodo verde en el que se mezcla la infraestructura verde urbana y periurbana. <br> Para ello, se plantea la creación de paseo perimetral de unos 600 metros de longitud que permita la plantación árboles y arbustos de especies diversas y sirva de para revegetar ese borde del parque dotacional y su conexión con el espacio natural de la vía pecuaria del Camino de Moledores. Estas líneas de arbolado mejorarán también la protección frente al ruido generado por la línea del ferrocarril de Alta Velocidad Madrid – Sevilla que limita el sector por el Oeste. Además, se recogerán las pluviales del sector en un pequeño tanque de tormentas para reutilizarlas en riegos, se permeabilizará el aparcamiento conectándolo a las nuevas vías perimetrales y liberando el acceso por la vía pecuaria vecina (Camino de Moledores), y se sustituirá el césped existente en la zona por una pradera natural.",
    properties1: [
